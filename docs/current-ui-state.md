...
- prochaine dette frontend immédiate : appliquer la même logique DRY aux pills de statut et aux chips de recommendation, sans relancer un design system complet
